...
export function activate(context) {
    ...
    // Register providers
    const completionProvider = vscode.languages.registerCompletionItemProvider({ scheme: 'file', language: 'solidity' }, new NatSpecCompletionProvider(), '@');
    const hoverProvider = vscode.languages.registerHoverProvider({ scheme: 'file', language: 'solidity' }, new NatSpecHoverProvider());
    // Register commands
